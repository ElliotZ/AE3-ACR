...
public static class SettingTab {
  public static void Build(JobViewWindow instance) {
    instance.AddTab("设置", _ => {
      ImGui.Text("ACR设置");
      string previewValue = GnbSettings.Instance.ACRMode switch {
          "Normal" => "日随",
      ...
      ImGui.Text("会从当前记录过的QT设置重置，爆发药QT不会被重置。");
      ImGui.Separator();
      ImGui.Text("点击按钮设置为高难默认设置（超火减伤默认关闭 突进默认开启） ");

      if (ImGui.Button("高难设置")) {
        Qt.Instance.NewDefault("突进起手", true);
        Qt.Instance.SetQt("突进起手", true);
        Qt.Instance.NewDefault("自动超火", false);
        Qt.Instance.SetQt("自动超火", false);
        Qt.Instance.NewDefault("减伤", false);
        Qt.Instance.SetQt("减伤", false);
        Qt.Instance.NewDefault("雪仇", false);
        Qt.Instance.SetQt("雪仇", false);
        Qt.Instance.NewDefault("自动刚玉", false);
        Qt.Instance.SetQt("自动刚玉", false);
        Qt.Instance.NewDefault("音速破", true);
        Qt.Instance.SetQt("音速破", true);
        Qt.Instance.NewDefault("弓形冲波", true);
        Qt.Instance.SetQt("弓形冲波", true);
        Qt.Instance.NewDefault("狮心连", true);
        Qt.Instance.SetQt("狮心连", true);
        Qt.Instance.NewDefault("爆发击", true);
        Qt.Instance.SetQt("爆发击", true);
        Qt.Instance.NewDefault("子弹连", true);
        Qt.Instance.SetQt("子弹连", true);
        Qt.Instance.NewDefault("爆发", true);
        Qt.Instance.SetQt("爆发", true);
        Qt.Instance.NewDefault("无情", true);
        Qt.Instance.SetQt("无情", true);
        Qt.Instance.NewDefault("强制变命运", false);
        Qt.Instance.SetQt("强制变命运", false);
        Qt.Instance.NewDefault("强制爆发击", false);
        Qt.Instance.SetQt("强制爆发击", false);
        Qt.Instance.NewDefault("优先音速破", false);
        Qt.Instance.SetQt("优先音速破", false);
        Qt.Instance.NewDefault("TP开怪", false);
        Qt.Instance.SetQt("TP开怪", false);
        Qt.Instance.NewDefault("血壤", true);
        Qt.Instance.SetQt("血壤", true);
        Qt.Instance.NewDefault("倍攻", true);
        Qt.Instance.SetQt("倍攻", true);
        Qt.Instance.NewDefault("爆破领域", true);
        Qt.Instance.SetQt("爆破领域", true);
        Qt.Instance.NewDefault("使用基础Gcd", true);
        Qt.Instance.SetQt("使用基础Gcd", true);
        Qt.Instance.NewDefault("极光", false);
        Qt.Instance.SetQt("极光", false);
        Qt.Instance.NewDefault("自动拉怪", false);
        Qt.Instance.SetQt("自动拉怪", false);

        if ((GnbSettings.Instance.ACRMode == "HighEnd1")
         || (GnbSettings.Instance.ACRMode == "HighEnd3")) {
          Qt.Instance.NewDefault("无情后半", true);
          Qt.Instance.SetQt("无情后半", true);
        }
      ...
      if (ImGui.Button("普通本设置")) {
        Qt.Instance.NewDefault("突进起手", false);
        Qt.Instance.SetQt("突进起手", false);
        Qt.Instance.NewDefault("自动超火", true);
        Qt.Instance.SetQt("自动超火", true);
        Qt.Instance.NewDefault("减伤", true);
        Qt.Instance.SetQt("减伤", true);
        Qt.Instance.NewDefault("音速破", true);
        Qt.Instance.SetQt("音速破", true);
        Qt.Instance.NewDefault("雪仇", true);
        Qt.Instance.SetQt("雪仇", true);
        Qt.Instance.NewDefault("自动刚玉", true);
        Qt.Instance.SetQt("自动刚玉", true);
        Qt.Instance.NewDefault("音速破", true);
        Qt.Instance.SetQt("音速破", true);
        Qt.Instance.NewDefault("弓形冲波", true);
        Qt.Instance.SetQt("弓形冲波", true);
        ...
        Qt.Instance.NewDefault("使用基础Gcd", true);
        Qt.Instance.SetQt("使用基础Gcd", true);
        Qt.Instance.NewDefault("极光", true);
        Qt.Instance.SetQt("极光", true);
        GnbSettings.Instance.Save();
      }
      ...
      if (ImGui.CollapsingHeader("阈值设置")) {
        ImGuiHelper.LeftInputInt("突进时间(倒数多少ms突进)建议400",
                                 ref GnbSettings.Instance.Time,
                                 100,
                                 10000,
                                 100);
        ImGuiHelper.LeftInputInt("大星云时间(倒数多少ms开)",
                                 ref GnbSettings.Instance.大星云Time,
                                 100,
                                 10000,
                                 100);
        ImGuiHelper.LeftInputInt("铁壁时间(倒数多少ms开)",
                                 ref GnbSettings.Instance.铁壁Time,
                                 100,
                                 10000,
                                 100);
        ...
        if (ImGui.SliderFloat("超火流星阈值",
                              ref GnbSettings.Instance.超火流星阈值,
                              0f,
                              0.99f)) {
          GnbSettings.Instance.Save();
        }
        ...
        if (ImGui.SliderFloat("刚玉之心阈值",
                              ref GnbSettings.Instance.刚玉之心阈值,
                              0f,
                              0.99f)) {
          GnbSettings.Instance.Save();
        }
        ...
        if (ImGui.Button("默认设置")) {
          ...
          Qt.Instance.NewDefault("自动刚玉", true);
          Qt.Instance.SetQt("自动刚玉", true);
          Qt.Instance.NewDefault("倾泻爆发", false);
          Qt.Instance.SetQt("倾泻爆发", false);
          GnbSettings.Instance.Save();
        }
      }
